...
VALUES ('sanas', 'Sanas Febriyan');
INSERT INTO user(id, name)
VALUES ('febriyan', 'Sanas Febriyan');
...
INSERT INTO notification(title, detail, create_at, user_id)
VALUES ('Contoh Pembayaran', 'Detail Pembayaran', CURRENT_TIMESTAMP(), 'febriyan');
...
SELECT *
FROM notification
WHERE (user_id = 'sanas' OR user_id IS NULL)
ORDER BY create_at DESC;

SELECT *
FROM notification
WHERE (user_id = 'febriyan' OR user_id IS NULL)
ORDER BY create_at DESC;
...
WHERE (n.user_id = 'sanas' OR n.user_id IS NULL)
ORDER BY n.create_at DESC;

SELECT *
FROM notification n
         JOIN category c ON (n.category_id = c.id)
WHERE (n.user_id = 'febriyan' OR n.user_id IS NULL)
ORDER BY n.create_at DESC;
...
WHERE (n.user_id = 'sanas' OR n.user_id IS NULL)
  AND (nr.user_id = 'sanas' OR nr.user_id IS NULL)
ORDER BY n.create_at DESC;

INSERT INTO notification(title, detail, category_id, user_id, create_at)
VALUES ('Contoh Pesanan Lagi', 'Detail Pesanan lagi', 'INFO', 'sanas', CURRENT_TIMESTAMP());
INSERT INTO notification(title, detail, category_id, user_id, create_at)
